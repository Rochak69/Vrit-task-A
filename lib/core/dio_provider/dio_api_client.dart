...
import 'package:lookup/core/config/environment_helper.dart';

import 'package:lookup/core/dio_provider/api_error.dart';
import 'package:lookup/core/dio_provider/api_response.dart';
import 'package:lookup/core/preferences/preferences.dart';
  ...
  Future<T> httpGet<T>(
    ...
    try {
      ...
      _dio.options.headers = {
        ...
        'Authorization':
            'LSKM6ftfDQ218T6m2aYBcJxYgTmfK7xCHLn7f17EPaxo9FPCb4veIP9b',
      };

      response = await _dio.get(serviceName, queryParameters: queryParameters);
